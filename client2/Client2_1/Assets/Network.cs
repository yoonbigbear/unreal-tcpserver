...
public class Network : MonoBehaviour
{
	...
	IEnumerator Packetreceive()
	{
        ...
        while (true)
        {
            ...
            socket.Receive(recv);
            var recvBuf = new ByteBuffer(recv);
                ...
                case Protocol.EnterFieldSync:
                    {
                        ...
                        for (int i = 0; i < wor.ObjIdLength; ++i)
                        {
                            ...
                            var pos = wor.Pos(i);
                            Debug.Log($" 입장 {objid} {pos.Value.X} {pos.Value.Y} {pos.Value.Z}");
                ...
                case Protocol.MoveStopSync:
                    {
                        ...
                        Debug.Log($" 도착 {objid} {pos.Value.X} {pos.Value.Y} {pos.Value.Z}");
