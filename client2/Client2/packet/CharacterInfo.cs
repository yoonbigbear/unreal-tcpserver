...
public struct CharacterInfo : IFlatbufferObject
{
  ...
  public byte JobClass { get { int o = __p.__offset(4); return o != 0 ? __p.bb.Get(o + __p.bb_pos) : (byte)0; } }
  ...
  public static Offset<CharacterInfo> CreateCharacterInfo(FlatBufferBuilder builder,
    ...
    CharacterInfo.AddJobClass(builder, job_class);
  ...
  public static void AddJobClass(FlatBufferBuilder builder, byte jobClass) { builder.AddByte(0, jobClass, 0); }
