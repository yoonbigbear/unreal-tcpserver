...
public struct CreateCharacterReq : IFlatbufferObject
{
  ...
  public byte Class { get { int o = __p.__offset(6); return o != 0 ? __p.bb.Get(o + __p.bb_pos) : (byte)0; } }
  ...
  public static Offset<account.CreateCharacterReq> CreateCreateCharacterReq(FlatBufferBuilder builder,
    ...
    CreateCharacterReq.AddClass(builder, @class);
  ...
  public static void AddClass(FlatBufferBuilder builder, byte @class) { builder.AddByte(1, @class, 0); }
